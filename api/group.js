/ api/group.js
// Esta función corre en Vercel y es la que llama a Claude de forma segura
// El browser nunca ve la API key — solo este archivo la usa
...
export default async function handler(req, res) {
  ...
  // Convierte la lista a texto para el prompt
